    ...
    <div class="content clearfix">
        ...
        <div class="side-menu">
            <ul class="menu-list">
                ...
                <li>
                    <a href="/ajhouse/questMessages/${sessionScope.ajUser.tel}"<%--id=11--%> class="cur"><i class="iconfont"></i>我的提问</a>
                </li>
...
<table border="1" align="center"   bgcolor=""  width="800px" height="100%" >
 <tr height="50px">
    ...
    <td ><div class="STYLE1" align="center">问题内容</div></td>
  </tr>
				<c:forEach items="${quest.rows}" var="s">
				<tr height="50px">
					<td>${s.quesTitle}</td>
					<td>${s.quesContent}</td>
				</tr>
