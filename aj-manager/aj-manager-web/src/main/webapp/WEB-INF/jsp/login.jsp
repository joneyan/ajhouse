...
<div id="content">
    <div class="simple-header">
        <div id="header-box">
            <div class="logo">
                <a class="ajk-logo" target="_blank">乐安居</a>
                <a class="broker-logo">网络门店管理系统 </a>
            </div>
        </div>
    </div>    <!-- 内容 -->
    <div class="content-box">
        <h2 class="login-title">网络门店用户登录</h2>
                ...
                <div class="login_border clear_box">
                    ...
                    <div class="login_block ershoufang" style="display: block">
                        <form method="post" action="" id="ershoufang_login" name="ershoufang_login">
                            ...
                            <dl class="login_form">
                                <dt>用户名</dt>
                                <dd><input type="text" name="acountnum" id="p_username" value="输入手机号或用户名" style="height:30px"
                                           class="default_color input_bg login_input220 c_grayc"/><span id="sp1"></span> </dd>
                                <dt>密码</dt>
...
<div id="footer">
    ...
    <p>
        <a href="http://www.anjuke.com/aboutus.html" rel="nofollow" hidefocus="true" target="_blank">关于我们</a>
        <em>|</em>
        <a target="_blank" href="http://shanghai.anjuke.com/contactus.html">联系我们</a>
        <em>|</em>
        <a target="_blank" href="http://shanghai.anjuke.com/user-agreement.html">用户协议</a>
    </p>
</div>
